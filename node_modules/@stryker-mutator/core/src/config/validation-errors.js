...
function mergeTypeErrorsByPath(typeErrors) {
    ...
    function mergeTypeErrors(typeErrors) {
        ...
        return Object.assign(Object.assign({}, typeErrors[0]), { params });
    }
}
/**
...
function describeError(error) {
    ...
    switch (error.keyword) {
        ...
        case 'enum':
            return `${errorPrefix} should be one of the allowed values (${error.params.allowedValues
                .map(stringify)
