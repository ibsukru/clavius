...
exports.StrykerInquirer = void 0;
...
class StrykerInquirer {
    ...
    async promptTestRunners(options) {
        ...
        if (options.length) {
            const choices = options.map((_) => _.name);
            choices.push(new inquirer.Separator());
            choices.push(command_test_runner_1.default.runnerName);
            const answers = await inquirer.prompt({
                choices,
            ...
            return (_a = options.filter((_) => _.name === answers.testRunner)[0]) !== null && _a !== void 0 ? _a : { name: command_test_runner_1.default.runnerName, pkg: null };
        }
        else {
            return { name: command_test_runner_1.default.runnerName, pkg: null };
        }
    }
